...
export class Mission2 implements MissionInterface {
    ...
    constructor(scene: THREE.Scene, camera: THREE.Camera, enemies: any) {
        ...
        this.camera = camera;
        this.objectives = [
            new FindObject({ position: new THREE.Vector3(-16, 1, 45), texturePath: './textures/mission_items/gems/blue_gem.png' }, this.scene, this.camera),
            new FindObject({ position: new THREE.Vector3(16, 1, 45), texturePath: './textures/mission_items/gems/red_gem.png' }, this.scene, this.camera),
    ...
    public Init(): void {
        ...
        this.objectives[1].generateObject(this.scene);
    }
